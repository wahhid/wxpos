...
from pos.modules.user.objects.role import Role, role_permission_link
from pos.modules.user.objects.permission import Permission, MenuRestriction, permission_restriction_link
